...
--
-- Host: 127.0.0.1
-- Czas generowania: 25 Maj 2023, 18:17
...
--
-- Zrzut danych tabeli `danekontaktowe`
--
...
--
-- Zrzut danych tabeli `druch_has_interwencja`
--
...
--
-- Zrzut danych tabeli `interwencja`
--
...
(1, 'Ratowniczo-Gaśnicza', '2023-05-24', 8, 2);
...
--
-- Zrzut danych tabeli `osobazglaszajaca`
--
...
--
-- Zrzut danych tabeli `osobazglaszajaca_has_interwencja`
--
...
--
-- Zrzut danych tabeli `remiza_has_interwencja`
--
...
--
-- Zrzut danych tabeli `wydarzenia_has_druch`
--
...
--
-- AUTO_INCREMENT dla tabeli `danekontaktowe`
--
ALTER TABLE `danekontaktowe`
  MODIFY `idDaneKontaktowe` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT dla tabeli `druch`
--
ALTER TABLE `druch`
  MODIFY `idDruch` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT dla tabeli `interwencja`
--
ALTER TABLE `interwencja`
  MODIFY `idInterwencja` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT dla tabeli `osobazglaszajaca`
--
ALTER TABLE `osobazglaszajaca`
  MODIFY `idOsobaZglaszajaca` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT dla tabeli `remiza`
--
ALTER TABLE `remiza`
  MODIFY `idRemiza` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT dla tabeli `wydarzenia`
--
ALTER TABLE `wydarzenia`
  MODIFY `idWydarzenia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT dla tabeli `wyposazenie`
--
ALTER TABLE `wyposazenie`
  MODIFY `idWyposazenie` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- Ograniczenia dla tabeli `druch_has_interwencja`
--
ALTER TABLE `druch_has_interwencja`
...
--
-- Ograniczenia dla tabeli `interwencja`
--
ALTER TABLE `interwencja`
...
--
-- Ograniczenia dla tabeli `osobazglaszajaca`
--
ALTER TABLE `osobazglaszajaca`
...
--
-- Ograniczenia dla tabeli `osobazglaszajaca_has_interwencja`
--
ALTER TABLE `osobazglaszajaca_has_interwencja`
...
--
-- Ograniczenia dla tabeli `remiza`
--
ALTER TABLE `remiza`
...
--
-- Ograniczenia dla tabeli `remiza_has_interwencja`
--
ALTER TABLE `remiza_has_interwencja`
...
--
-- Ograniczenia dla tabeli `wydarzenia_has_druch`
--
ALTER TABLE `wydarzenia_has_druch`
